...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_04.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_04.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","acc_entity_replace","coverage_3_04.json")
    html_path = os.path.join(base_dir,"mutation_test","output","acc_entity_replace","3_04.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","acc_entity_replace","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","acc_entity_replace","LLM_analysis")
