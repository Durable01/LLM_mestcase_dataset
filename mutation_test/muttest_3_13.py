...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_13.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_13.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","lim_reload_textdescription","coverage_3_13.json")
    html_path = os.path.join(base_dir,"mutation_test","output","lim_reload_textdescription","3_13.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","lim_reload_textdescription","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","lim_reload_textdescription","LLM_analysis")
