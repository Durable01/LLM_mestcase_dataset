...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_14.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_14.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","lim_valueconstrain_transform","coverage_3_14.json")
    html_path = os.path.join(base_dir,"mutation_test","output","lim_valueconstrain_transform","3_14.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","lim_valueconstrain_transform","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","lim_valueconstrain_transform","LLM_analysis")
