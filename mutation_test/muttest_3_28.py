...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_28.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_28.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","att_value_judge","coverage_3_28.json")
    html_path = os.path.join(base_dir,"mutation_test","output","att_value_judge","3_28.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","att_value_judge","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","att_value_judge","LLM_analysis")
