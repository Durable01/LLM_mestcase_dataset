...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_26.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_26.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output"," att_relation_completeness","coverage_3_26.json")
    html_path = os.path.join(base_dir,"mutation_test","output","att_relation_completeness","3_26.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","att_relation_completeness","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","att_relation_completeness","LLM_analysis")
