...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_10.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_10.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","rob_disturb_entityAssociated","coverage_3_10.json")
    html_path = os.path.join(base_dir,"mutation_test","output","rob_disturb_entityAssociated","3_10.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","rob_disturb_entityAssociated","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","rob_disturb_entityAssociated","LLM_analysis")
