...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_12.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_12.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","cons_reload_parallelrelation","coverage_3_12.json")
    html_path = os.path.join(base_dir,"mutation_test","output","cons_reload_parallelrelation","3_12.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","cons_reload_parallelrelation","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","cons_reload_parallelrelation","LLM_analysis")
