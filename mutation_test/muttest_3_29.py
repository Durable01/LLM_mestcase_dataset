...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_29.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_29.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","att_fuzzy_inference","coverage_3_29.json")
    html_path = os.path.join(base_dir,"mutation_test","output","att_fuzzy_inference","3_29.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","att_fuzzy_inference","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","att_fuzzy_inference","LLM_analysis")
