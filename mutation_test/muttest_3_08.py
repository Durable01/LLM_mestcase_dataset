...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_08.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_08.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","rob_homophone_disturb","coverage_3_08.json")
    html_path = os.path.join(base_dir,"mutation_test","output","rob_homophone_disturb","3_08.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","rob_homophone_disturb","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","rob_homophone_disturb","LLM_analysis")
