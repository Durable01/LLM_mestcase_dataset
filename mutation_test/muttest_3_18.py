...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_18.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_18.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","inf_inference_chain","coverage_3_18.json")
    html_path = os.path.join(base_dir,"mutation_test","output","inf_inference_chain","3_18.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","inf_inference_chain","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","inf_inference_chain","LLM_analysis")
