...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_09.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_09.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","rob_synonym_algorithm","coverage_3_09.json")
    html_path = os.path.join(base_dir,"mutation_test","output","rob_synonym_algorithm","3_09.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","rob_synonym_algorithm","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","rob_synonym_algorithm","LLM_analysis")
