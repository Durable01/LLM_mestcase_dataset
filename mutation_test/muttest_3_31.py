...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_31.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_31.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","att_semantic_irrationality","coverage_3_31.json")
    html_path = os.path.join(base_dir,"mutation_test","output","att_semantic_irrationality","3_31.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","att_semantic_irrationality","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","att_semantic_irrationality","LLM_analysis")
