...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_27.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_27.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","att_relation_independence","coverage_3_27.json")
    html_path = os.path.join(base_dir,"mutation_test","output","att_relation_independence","3_27.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","att_relation_independence","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","att_relation_independence","LLM_analysis")
