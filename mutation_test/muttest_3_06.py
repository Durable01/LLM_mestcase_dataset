...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_06.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_06.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","acc_transform_knowledgeRepresent","coverage_3_06.json")
    html_path = os.path.join(base_dir,"mutation_test","output","acc_transform_knowledgeRepresent","3_06.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","acc_transform_knowledgeRepresent","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","acc_transform_knowledgeRepresent","LLM_analysis")
