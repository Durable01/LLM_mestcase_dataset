...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_19.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_19.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","inf_inference_trap","coverage_3_19.json")
    html_path = os.path.join(base_dir,"mutation_test","output","inf_inference_trap","3_19.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","inf_inference_trap","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","inf_inference_trap","LLM_analysis")
