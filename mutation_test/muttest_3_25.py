...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_25.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_25.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","att_relation_domain","coverage_3_25.json")
    html_path = os.path.join(base_dir,"mutation_test","output","att_relation_domain","3_25.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","att_relation_domain","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","att_relation_domain","LLM_analysis")
