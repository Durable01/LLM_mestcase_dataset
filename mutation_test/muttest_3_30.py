...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_30.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_30.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","att_unit_irrationality","coverage_3_30.json")
    html_path = os.path.join(base_dir,"mutation_test","output","att_unit_irrationality","3_30.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","att_unit_irrationality","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","att_unit_irrationality","LLM_analysis")
