...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_05.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_05.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","acc_KG_confuse","coverage_3_05.json")
    html_path = os.path.join(base_dir,"mutation_test","output","acc_KG_confuse","3_05.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","acc_KG_confuse","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","acc_KG_confuse","LLM_analysis")
