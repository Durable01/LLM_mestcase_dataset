...
if __name__ == "__main__":
    ...
    #记得写好配置文件
    config_path = os.path.join(base_dir,"mutation_test","mut_config","3_16.toml")
    work_db_path = os.path.join(base_dir,"mutation_test","mut_db","3_16.sqlite")
    coverage_json_path = os.path.join(base_dir,"coverage_test","output","lim_LLMgenerate_mask","coverage_3_16.json")
    html_path = os.path.join(base_dir,"mutation_test","output","lim_LLMgenerate_mask","3_16.html")
    survival_dir = os.path.join(base_dir,"mutation_test","output","lim_LLMgenerate_mask","survivals")
    analysis_dir = os.path.join(base_dir,"mutation_test","output","lim_LLMgenerate_mask","LLM_analysis")
